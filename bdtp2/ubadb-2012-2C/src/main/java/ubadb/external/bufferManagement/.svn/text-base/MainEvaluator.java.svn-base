...
import ubadb.core.components.bufferManager.bufferPool.pools.TouchCountBufferPool;
...
import ubadb.core.components.bufferManager.bufferPool.replacementStrategies.ru.lru.LRUReplacementStrategy;
import ubadb.core.components.bufferManager.bufferPool.replacementStrategies.ru.mru.MRUReplacementStrategy;
...
public class MainEvaluator
{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			String traceFileName = "generated/BNLJ-SaleXProduct-group_100.trace";
			for(int bufferPoolSize = 200; bufferPoolSize<=1000; bufferPoolSize=bufferPoolSize+20){
